...
function pay2m_generate_pix($order_id, $amount, $client_name, $client_cpf, $order_expiration)
{
    ...
    $pix_qrcode = base64_encode($pix_code);
    
    $code = $payment['reference_code'];
    $sql = 'UPDATE order_list' . "\r\n" . '    SET payment_method = \'' . $payment_method . '\', pix_code = \'' . $pix_code . '\', pix_qrcode = \'' . $pix_qrcode . '\', id_mp = \'' . $code . '\', order_expiration = \'' . $order_expiration . '\'' . "\r\n" . '    WHERE id = ' . $order_id;
