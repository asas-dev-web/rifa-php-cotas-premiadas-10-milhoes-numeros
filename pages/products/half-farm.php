                        ...
                        <div class="row px-2">
                            ...
                            foreach ($discounts as $discount) { ?>
                                <div class="col-auto px-1 mb-2">
                                    <button onclick="qtyExpress('<?= $discount['qty'] ?>', true);"
                                        class="btn btn-success w-100 btn-sm py-0 px-2 text-nowrap font-xss">
                                        <span class="font-weight-500">
                                            <b class="font-weight-600"><span
                                                    id="discount_qty_<?= $count ?>"><?= $discount['qty'] ?></span></b>
                                            <small>por R$</small>
                                            <span class="font-weight-600">
                                                <span id="discount_amount_<?= $count ?>"
                                                    style="display:none"><?= $discount['amount'] ?></span>
                                                <?php
                ...
                <div class="app-card card bg-success text-white mb-2">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="rounded-pill" style="width: 56px; height: 56px; position: relative; overflow: hidden;">
                                    <div
                                        ...
                                        <img alt="<?= $winner['name'] ?>" src="<?php echo base_url; ?>assets/img/avatar.jpg"
                            ...
                            <div class="col">
                                <h5 class="mb-0"><?= $count ?>º - <?= $winner['name'] ?>&nbsp;<i
                                        class="bi bi-check-circle text-white-50"></i></h5>
            ...
            <div class="modal-body checkout">
                <div class="alert alert-info p-2 mb-2 font-xs"><i class="bi bi-check-circle"></i> Você está
                    adquirindo<span class="font-weight-500">&nbsp;<span id="qty_cotas"></span>
                        ...
                        class="font-weight-500">&nbsp;<?= isset($name) ? $name : '' ?></span>,<span>&nbsp;seus números
                ...
                <button data-id id="place_order" class="btn btn-success w-100 mb-2">Concluir reserva <i
